...
<li class="nav-item">
          ...
          <input class="form-control" name="hangsanxuat" type="text" placeholder="Thông tin tìm kiếm">
          ...
          <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="d-block img-fluid" src="../../img/anh1.png" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="../../img/anh2.png" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="../../img/anh3.jpg" alt="Third slide">
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><?php echo($value['hedieuhanh']) ?></p>
